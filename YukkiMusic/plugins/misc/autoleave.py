            ...
            if datetime.now() > timer:
                ...
                try:
                    await app.send_message(
                        chat_id,
                        "Bot has left voice chat due to inactivity to avoid overload on servers. No-one was listening to the bot on voice chat, Want me back on VC Then Play songs.",
                    )
                except:
                    continue
